    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildSingleCourseCard(popularCourses[index]);
              },
            ),
          ),
          const SizedBox(height: 20),
          ...
          // 🏫 Kampüs Hayatı
          _buildSectionTitle("Kampüs Hayatı"),
          const SizedBox(height: 8),
          _buildScoreCard(),
          const SizedBox(height: 8),
...
floatingActionButton: FloatingActionButton(
  ...
  onPressed: () async { // async olarak işaretle
    // Yeni sayfayı aç ve sonuç bekle
    final result = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const NewPostScreen()),
    );

    // Eğer yeni bir gönderi verisi geldiyse listeyi güncelle
              ...
              children: [
                Row(
                  children: [
                    ...
                    const SizedBox(width: 4),
                    Text('${post['shares']}', style: TextStyle(color: Colors.grey.shade700)),
                  ],
                ),
                Text(
                  post['time'],
  ...
  Widget _buildSingleCourseCard(Map<String, String> courseData) {
    return Container(
      width: 180,
